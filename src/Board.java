...
public class Board extends JPanel implements KeyListener
{
  ...
  private static BufferedImage Letter_A;
  private static BufferedImage Letter_S;
  private static BufferedImage Letter_D;
  private static BufferedImage Letter_F;
  ...
  private static final Color GRID_COLOR_C = new Color(0,0,0);
  ...
  {
    super( true );
    JFrame f = new JFrame( "Tap-Tap The Pegs" );
  ...
  {
	  try {
	  Letter_A = ImageIO.read(new File("Letter A.jpg"));
	  Letter_S = ImageIO.read(new File("Letter S.jpg"));
	  Letter_D = ImageIO.read(new File("Letter D.jpg"));
	  Letter_F = ImageIO.read(new File("Letter F.jpg"));
	  } catch (IOException e) {
    ...
    for (int i = 0; i < this.grid.length; i++)
    {
      ...
      {    
        if ((i%2 == 0 && j%2 != 0 && i != 1) || (i%2 != 0 && j%2 == 0 && i != 1))
          g.setColor(GRID_COLOR_A);
        else if ((i%2 == 1 && j%2 != 0 && i != 1) || (i%2 != 1 && j%2 == 0 && i != 1))
          g.setColor(GRID_COLOR_B);
        else
          g.setColor(GRID_COLOR_C);
        
        g.drawImage(Letter_A, 30, 30, 60, 60, null);
        g.drawImage(Letter_S, 30, 90, 60, 60, null);
        g.drawImage(Letter_D, 30, 150, 60, 60, null);
        g.drawImage(Letter_F, 30, 210, 60, 60, null);
